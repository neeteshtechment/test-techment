...
ActiveRecord::Schema.define(version: 2020_02_22_075127) do
  ...
  create_table "tv_shows", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "channel_id"
    t.text "name"
